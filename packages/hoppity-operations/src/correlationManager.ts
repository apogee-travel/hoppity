 ...
 *
 * Adapted from hoppity-rpc's createCorrelationManager. The key difference: this
 * creates a fresh instance on every call (no module-level singleton), so each
 * withOperations middleware invocation gets isolated state.
 */
